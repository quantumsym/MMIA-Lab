...
def demonstrate_tsp_optimization():
    ...
    # Plot optimal tour
    plot_tsp_tour(cities, optimal_tour, title='Optimal TSP Tour (Brute Force)',
                 output_file='tsp_tour_optimal.svg')
    
    # Plot SA tour
    plot_tsp_tour(cities, sa_tour, title='TSP Tour (Simulated Annealing)',
                 output_file='tsp_tour_sa.svg')
    
    # Plot PT tour
    plot_tsp_tour(cities, pt_tour, title='TSP Tour (Parallel Tempering)',
                 output_file='tsp_tour_pt.svg')
    
    # Plot energy evolution from SA
    plot_tsp_energy_evolution(sa_results['energy_history'], 
                             output_file='tsp_energy_evolution_sa.svg')
    
    # Plot comparison of all three tours
    plot_tsp_comparison(cities, optimal_tour, sa_tour, pt_tour,
                       output_file='tsp_comparison.svg')
    
    # Plot tour length comparison
    tour_lengths = [optimal_length, sa_length, pt_length]
