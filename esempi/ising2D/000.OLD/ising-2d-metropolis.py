#!/usr/bin/env python
#from numpy.random import choiche, random, randint
import numpy as np
import matplotlib.pyplot as plt

# Parametri principali
size = 50             # Dimensione del lattice (50x50)
temperature = 1.5   # Temperatura iniziale (vicino alla T critica ~2.27)
num_steps = 3000      # Numero di passi di evoluzione
